...
final class DataServiceManager{
    ...
    func loginUser(username : String , password : String, completion : @escaping (_ result: Any? ) -> Void)
    {
        ...
        do{
            ...
            print(jsonData)
            ApiManager.sharedInstance.postApiData(requestUrl: loginurl, requestBody: jsonData! ,resultType: LoginData.self) { (response ) in
                print("Sucesss")
    ...
    func verifyotp( userName : String ,otp : String , completion : @escaping (_ result: Any? ) -> Void){
        ...
        do{
            ...
            ApiManager.sharedInstance.postApiData(requestUrl: urlString!, requestBody: jsonData!, resultType: LoginData.self) { result in
                print(result)
    ...
    func getclinicdetails(completionHandler: @escaping (Array<CDClinicDetail>?) -> Void){
        
        let url = URL(string: "\(Constants.KURL.KStagingURL)\(Constants.KAPIPaths.KClinicList)")!
        ApiManager.sharedInstance.getApiData(requestUrl: url, resultType: CDClinicDetail?.self) { result in
            if let result = result {
                print(result)
                completionHandler(result as? Array<CDClinicDetail> )
            }
